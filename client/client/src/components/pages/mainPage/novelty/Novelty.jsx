        ...
        <div className="container">
            <div className="novelty__wrapper">
                <div className="novelty__content content-novelty">
                    ...
                    <a href="#" className="content-novelty__more link-more">Больше новинок</a>
                </div>
                <div className="novelty__slider slider-novelty">
                    ...
                    breakpoints={
                      ...
                      className="slider-novelty__wrapper">
                        <SwiperSlide className="slider-novelty__slide slide-novelty__card card card_height">
                            <a href="card.html" className="card__img-link slide-novelty__img-link">
